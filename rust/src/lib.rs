//! Windissect-generated Rust FFI bindings for Windows.StateRepository.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "70582F4CAD0E8473BBF0389EC93DDC0B";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 3395249903;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 28] = [87, 105, 110, 100, 111, 119, 115, 46, 83, 116, 97, 116, 101, 82, 101, 112, 111, 115, 105, 116, 111, 114, 121, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 3395249903 { return 0; }
