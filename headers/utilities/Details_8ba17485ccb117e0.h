...
// Reconstructed from Windows.StateRepository.dll by Windissect. 315 member(s).
...
public /*unspecified*/:
    ...
    // Category: Method | Source: PDB Internal
    // Symbol: ?UnregisterObjects@Details@WRL@Microsoft@@YAJPEAVModuleBase@123@PEBG@Z
    long UnregisterObjects(WindissectOpaque *, unsigned short const *);
};
} // namespace Microsoft::WRL
